...
class SafeBase64(BaseX):
    alphabet = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvxwyz0123456789-_"


class SafeBase32(BaseX):
    alphabet = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567"


class SafeBase16(BaseX):
...
base62 = Base62()
base64 = Base64()
safe_base64 = SafeBase64()
safe_base32 = SafeBase32()
safe_base16 = SafeBase16()
